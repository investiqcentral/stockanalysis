...
#Income Statement
            ...
            try:
                ...
                income_cleaned_text = income_cleaned_text.replace("$", "\$").replace("#", "\#").replace(">", "\>")
...
#Balance Sheet
            ...
            try:
                ...
                balance_cleaned_text = balance_cleaned_text.replace("$", "\$").replace("#", "\#").replace(">", "\>")
...
#Cashflow Statement
            ...
            try:
                ...
                cashflow_cleaned_text = cashflow_cleaned_text.replace("$", "\$").replace("#", "\#").replace(">", "\>")
